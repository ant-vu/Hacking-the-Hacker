...
public class SecuritySiteTwo extends Site {
	...
	public SecuritySiteTwo(String [] roster){
		this.e = roster;
	...
	public void update() { // maybe different update message for what has changed, keys etc
		System.out.println( "Attention Security Site Two, there has been a security update to the encryption protocols. Please update your security accordingly. The change is: " + protocol.getChange() );  // a unique message for the site to know when things have been updated while differentiating between recipients
	}
